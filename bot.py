...
def classic_fm2():
    subprocess.call('mpc clear', shell=True)
    subprocess.call("mpc clear;mpc add http://173.242.115.175:9331/;mpc play",shell=True)
    subprocess.call('mpc play', shell=True)
#Aaha FM 91.9
def classic_fm3():
    subprocess.call('mpc clear', shell=True)
    subprocess.call("mpc clear;mpc add http://173.242.115.175:9372/;mpc play",shell=True)
    subprocess.call('mpc play', shell=True)
#Rainbow FM 101.4
def classic_fm4():
    subprocess.call('mpc clear', shell=True)
    subprocess.call("mpc clear;mpc add http://euroshoutcast.com:8000/;mpc play",shell=True)
    subprocess.call('mpc play', shell=True)
def news():
    subprocess.call('mpc clear', shell=True)
...
def process_event(assistant, event):
    ...
    GPIO.setup(12,GPIO.OUT)
        ...
        if text == 'check audio':
            ...
            assistant.stop_conversation()
            say_ip()
        elif text == 'my radio 1':
            assistant.stop_conversation()
            classic_fm1()
        elif text == 'my radio 2':
            assistant.stop_conversation()
            classic_fm2()
        elif text == 'my radio 3':
            assistant.stop_conversation()
            classic_fm3()
        elif text == 'my radio 4':
            assistant.stop_conversation()
            classic_fm4()
